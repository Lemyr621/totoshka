...
for ($i = 0;$i < 15;$i++) {
    ...
    if (!in_array($randPostId, $PostIdArray)) {
        ...
        if (strpos($wall[$randPostId]->text, 'Страна:')) {
            ...
            echo "<p><Img src=\"" . $wall[$randPostId]->attachments[0]->photo->sizes[2]->url . "\"</p>";
            echo "<p>" . $country . "</p>";
            echo "<p>" . $genre . "</p>";
            echo "<p>" . $rating . "</p>";
            echo "<p>" . $producer . "</p>";
            ...
            echo "<a href='https://vk.com/xfilm?w=wall-26750264_" . $wall[$randPostId]->id . "'> Смотреть на стене</a>";
            $postNumber++;
        }
    }
}
